...
namespace Game.GUI
{
    static class GuiHelpers
    {
        ...
        {
            { PartType.HEAD,  new PartFactoryType() { AssetName = "Textures/BodyParts/Zombie/Zombie_Head_01", SizeModifier = 1.0f, RotationEuler = 10.0f, YOffset = -1.3f } },
            { PartType.LEFTARM,  new PartFactoryType() { AssetName = "Textures/BodyParts/Zombie/Zombie_Arm_Left_01", SizeModifier = 0.4f, RotationEuler = 85.0f, YOffset = -2.2f } },
